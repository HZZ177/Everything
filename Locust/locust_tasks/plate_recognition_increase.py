...
class SSHManager:
    ...
    def check_file_exists(self, randomname, target_file_path):
        ...
        try:
            ...
            target_name = f"{name_part}_2.{extension}"
...
def identify_plate_randomly(client):
    ...
    image_path = 'A015DJ.jpg'
    target_plate = '桂A015DJ'    # 期望车牌号
    target_plate_pure = 'A015DJ'    # 期望车牌号，去除汉字部分
    target_chinese = '桂'   # 期望车牌汉字
    result = None
    flag = None
    ...
    if result.status_code != 200:
        ...
        ssh_manager.check_file_exists(randomname, target_file_path)
        ssh_manager.disconnect()
