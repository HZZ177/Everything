...
CALL add_element_unless_exists('column', 'api_supplementary_push', 'params', 'ALTER TABLE api_supplementary_push ADD COLUMN `params` longtext COMMENT "参数相关信息" AFTER header;');
CALL add_element_unless_exists('column', 'api_supplementary_push', 'reason', 'ALTER TABLE api_supplementary_push ADD COLUMN `reason` longtext COMMENT "推送失败原因或异常信息" AFTER params;');
